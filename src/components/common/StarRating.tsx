...
const StarIcon = ({
  ...
  >
    ...
    {half && (
      <path
        d="M11.9998 14.6564L14.8165 16.3769L14.0507 13.1664L16.5574 11.0192L13.2673 10.7554L11.9998 7.70792V14.6564Z"
        fill="white"
      />
    )}
  </svg>
...
const StarRating = ({ rating }: { rating: number }) => {
  ...
  return (
    <div className="flex items-center text-yellow-500">
      {Array.from({ length: floorRating }).map((_, index) => (
        <StarIcon key={`filled-${index}`} filled />
      ))}
