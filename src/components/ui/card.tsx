...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg inset-shadow-sm dark:inset-shadow-indigo-900/50 bg-gradient-to-br from-green-50 to-green-100 text-zinc-950 shadow-md flex flex-col rounded-t-2xl",
      className
    )}
    {...props}
  />
