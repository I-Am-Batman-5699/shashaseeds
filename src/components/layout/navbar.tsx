...
export default function HeaderNavbar({ isLoading = false }: { isLoading?: boolean }) {
    ...
    return (
        <header className={`top-0 sticky z-[100] w-full ${loadingClass} bg-gradient-to-br from-green-50 to-green-100`} aria-disabled={isLoading}>
            <div className={`lg:px-4 min-h-15 flex items-center justify-between border-b shadow-xs bg-gradient-to-r from-green-700 via-green-600 to-green-700 rounded-xl backdrop-blur-xl bg-opacity-70 m-0.5`}>
