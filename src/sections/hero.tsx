    ...
    return (
        <div className="relative min-h-[70vh] flex items-center overflow-hidden">
            ...
            <div className="mx-auto lg:min-w-[95%] xl:max-w-7xl md:pb-8 pb-4 md:pt-4 pt-1 flex-1 px-4 sm:px-6 lg:px-8">
                <div className="md:pb-[2rem] pb-[1rem] md:pt-[1rem] pt-[0.25rem] flex-1 px-4 sm:px-6 lg:px-8 rounded-2xl border border-theme bg-gradient-to-br from-green-50/50 to-green-100/50 dark:from-slate-900/50 dark:to-slate-950/50 shadow-lg md:p-4 p-2 inset-shadow-xs dark:inset-shadow-indigo-900/50 backdrop-blur-md">
                    {heroContentLoading || appDataLoading ? (
                        ...
                        <div className="rounded-[1.25rem] shadow-2xl md:p-[2rem] p-[1rem] backdrop-blur-md relative overflow-hidden">
