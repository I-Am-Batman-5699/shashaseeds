...
export default function ProductDetailPage() {
  ...
  if (loading || !product) return (
    <div className="p-8 min-h-screen flex items-center justify-center">
      <div className="text-xl font-semibold text-gray-600 animate-pulse">Loading Product Details...</div>
    </div>
  );
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-4 relative md:h-96 lg:h-[32rem]">
                  ...
                  <button
                    ...
                    className={`absolute top-2 right-2 p-2 rounded-full bg-white bg-opacity-80 hover:bg-opacity-100 transition-all z-10 shadow-lg ${isInWishlist ? 'text-red-500' : 'text-gray-400 hover:text-red-400'
                      }`}
